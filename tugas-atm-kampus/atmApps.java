...
public class atmApps {
    ...
    // Function jika pin benar akan lanjut ke tahap berikutnya jika salah tidak akan bisa melanjutkan ke tahap berikutnya
        ...
        do {
            ...
            switch (choice) {
                ...
                case 2:
                    withdraw(scanner);
                    break;
                //  Function sebagai tempat opsi pemilihan menu = menaruh atau menambah saldo kedalam riwayat transaksi
                case 3:
                    deposit(scanner);
                    break;
                //  Function sebagai tempat opsi pemilihan menu = melihat riwayat transaksi yang terjadi didalam 
                case 4:
